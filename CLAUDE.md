...
This file provides guidance to Claude Code (claude.ai/code) and other AI assistants when
working in this repository. It is the single source of truth for project documentation;
